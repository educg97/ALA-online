...
@Component({
  selector: 'app-buy-course-test',
  templateUrl: './buy-course-test.component.html',
  styleUrls: ['./buy-course-test.component.scss']
})
export class BuyCourseTestComponent implements OnInit {
    ...
    getCurrentCourse() {
        ...
        this.data.getCourse(id).subscribe(
            res => {
                ...
                this.currentCourse.schedules = Object.values(res['courseschedule']['schedules']);
    ...
    pay() {
        ...
        this.stripeInfo.stripeAmount = this.currentCourse['Precio Modulo'];
        ...
        this.data.sendCheckoutData(this.stripeInfo).subscribe(
            res => {
                ...
                this.userCourseInfo.course_price = this.currentCourse['Precio Modulo'];
